...
class TestWifiGuestDeviceDisconnectedFactory extends EventLogEntryFactoryTestBase<WifiGuestDeviceDisconnected> {
    ...
    @Override
    protected AbstractEventLogEntryFactory<WifiGuestDeviceDisconnected> createFactory() {
